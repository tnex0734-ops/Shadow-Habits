...
const characters = [
  ...
  },
  {
    ...
    abilities: ["Ten Shadows", "Divine Dogs", "Expansion — Max Elephant"],
  ...
  },
  {
    ...
    name: "Ratio Master",
    tagline: "7:3 Ratio",
    jjkRole: "Jujutsu High — Grade 1 (Former)",
  ...
  },
  {
    ...
    jjkRole: "Tokyo Jujutsu High — Grade 4 → Special Grade",
    ...
    abilities: ["Heavenly Restriction", "Panda Staff", "Zenin Clan Techniques"],
  ...
  },
  {
    ...
    abilities: ["Cursed Speech", "Blast Away", "Stop"],
  ...
  },
  {
    ...
    jjkRole: "Kyoto Jujutsu High — Grade 1",
    description: "Loud, passionate, unstoppable. He treats his rivals like best friends — because competition is just love in disguise.",
    color: "#818CF8",
    glow: "rgba(129,140,248,0.42)",
    image: "/src/assets/character-todo.svg",
    abilities: ["Boogie Woogie", "Jackpot Poker", "Divergent Fist Combo"],
    bindingVow: "I will show up every day with the energy of a best friend who believes in me.",
  },
];
